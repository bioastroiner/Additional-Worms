...
public final class ModItems {
    ...
    //Worms
    public static final RegistryObject<Item> WORM = ITEMS.register("item_worm",()-> new GeneralWormItem(wormBaseProperty,world -> new FarmerWormEntity(ModEntityTypes.WORM_ENTITY.get(),world)));
