...
public class ModTags {
    ...
    public static final class Blocks {
        ...
        private static ITag.INamedTag<Block> mod(String path) {
            return BlockTags.makeWrapperTag(new ResourceLocation(AddWorms.MODID, path).toString());
        }
    }
    ...
    public static final class Items {
        ...
        public static final ITag.INamedTag<Item> WORM = mod("worms/");
        public static final ITag.INamedTag<Item> WORM_FUNC = mod("worms/functional");
        ...
        private static ITag.INamedTag<Item> mod(String path) {
            return ItemTags.makeWrapperTag(new ResourceLocation(AddWorms.MODID, path).toString());
        }
    }
}
